...
import { ThemeProvider, useTheme } from './T2/context/ThemeContext'
import './T2.css'

const Content = () => {
    const { isDarkMode, toggleTheme, darkTheme, lightTheme } = useTheme()
    return (
        <>
            <div className='main-body'>


                <section id='header' style={isDarkMode ? darkTheme : lightTheme}>
                    <div>
                        <ul id='navbar'>
          ...
          {isDarkMode ? '☀️ Light Mode' : '🌑 Dark Mode'}
                ...
                <section className="section" style={isDarkMode ? darkTheme : lightTheme}>
...
const T2 = () => {
    document.title = 'Theme Website | Context'
